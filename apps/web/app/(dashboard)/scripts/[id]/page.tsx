...
export default async function ScriptDetailPage({ params }: { params: { slug: string; id: string } }) {
  ...
  return <ScriptDetailClient script={JSON.parse(JSON.stringify(script))} orgSlug={params.slug} />;
}
